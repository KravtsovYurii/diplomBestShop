...
namespace BestShop.Class
{
    class deaDAL
    {
        ...
        #region SELECT Method for Dealer
        public DataTable Select()
        {
            ...
            try
            {
                //Write SQL Query it Select all the Data from database
        ...
        public bool Insert(deaBLL dc)
        {
            ...
            try
            {
                string sql = "INSERT INTO tbl_dea_cust (name, email, contact, address, added_date, added_by) VALUES (@name, @email, @contact, @address, @added_date, @added_by)";
                SqlCommand cmd = new SqlCommand(sql, conn);
        ...
        public bool Update(deaBLL dc)
        {
            ...
            try
            {
                string sql = "UPDATE tbl_dea_cust SET name=@name, email=@email, contact=@contact, address=@address, added_date=@added_date, added_by=@added_by WHERE id=@id";
                SqlCommand cmd = new SqlCommand(sql, conn);
        ...
        public DataTable Search(string keyword)
        {
            ...
            try
            {
                string sql = "SELECT * FROM tbl_dea_cust WHERE id LIKE '%" + keyword + "%' OR name LIKE '%" + keyword + "%'";
        ...
        public deaBLL SearchDealerCustomerForTransaction(string keyword)
        {
            //Create an object for DeaCustBLL class
            deaBLL dc = new deaBLL();
        ...
        public deaBLL GetDeaCustIDFromName(string Name)
        {
            deaBLL dc = new deaBLL();
